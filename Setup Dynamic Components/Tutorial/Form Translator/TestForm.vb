...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.Fax, Me.Fax_Label, Me.Phone, Me.Phone_Label, Me.Address, Me.Address_Label, Me.CustName_Label, Me.CustID_Label, Me.CustomerName, Me.CustomerID, Me.TranslateForm, Me.LastButton, Me.NextButton, Me.PreviousButton, Me.FirstButton, Me.ExitButton})
...
#End Region
    ...
    Private Sub TestForm_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        oCustomers.Open("Customers", CN, oCustomers.CursorType.adOpenKeyset, oCustomers.LockType.adLockOptimistic)
        PopulateDate()
